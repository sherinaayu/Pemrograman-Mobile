...
import 'pages/item_page.dart'; // Ensure this file exists
      ...
      routes: <RouteBase>[
        GoRoute(
          ...
          builder: (BuildContext context, GoRouterState state) {
            return HomePage(); // Removed const keyword
          },
        ),
        GoRoute(
          path: '/item',
          builder: (BuildContext context, GoRouterState state) {
            final Item item =
                state.extra as Item; // Ensure Item is correctly passed
            return ItemPage(
                item: item); // Ensure this page is set up to receive an Item
          },
        ),
      ],
    );
